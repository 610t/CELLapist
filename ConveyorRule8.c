...
void 
  conveyorUpdateCellState8(CELL *celluar)
{
...
******/
     ...
     case CONVEYOR_UP_RIGHT:
      celluar->newstate = CONVEYOR_UP|CONVEYOR_RIGHT;
      break;
     case CONVEYOR_UP_LEFT:
      celluar->newstate = CONVEYOR_UP|CONVEYOR_LEFT;
      break;
     case CONVEYOR_DOWN_RIGHT:
      celluar->newstate = CONVEYOR_DOWN|CONVEYOR_RIGHT;
      break;
     case CONVEYOR_DOWN_LEFT:
      celluar->newstate = CONVEYOR_DOWN|CONVEYOR_LEFT;
      break;
